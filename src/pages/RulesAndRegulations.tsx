                ...
                >
                    <div className="flex items-center gap-4 mb-8">
                        <div className="bg-red-600 p-3 transform skew-x-[-12deg] shadow-lg shadow-red-500/20">
                            <Backpack className="w-6 h-6 text-slate-900 skew-x-[12deg]" />
                        </div>
                        <div>
                            <h2 className="text-3xl font-black uppercase italic tracking-wider text-slate-900">Mandatory Equipment</h2>
                        ...
                        {mandatoryGear.map((gear, i) => (
                            ...
                            >
                                ...
                                <div className="skew-x-[6deg]">
                                    <h3 className="font-black text-slate-900 uppercase italic tracking-wide mb-0.5 text-sm">{gear.item}</h3>
                ...
                >
                    <div className="flex items-center gap-4 mb-4">
                        <div className="bg-primary p-3 transform skew-x-[-12deg] shadow-lg shadow-primary/20">
                            <BookOpen className="w-6 h-6 text-slate-900 skew-x-[12deg]" />
                        </div>
                        <div>
                            <h2 className="text-3xl font-black uppercase italic tracking-wider text-slate-900">General Rules</h2>
                    ...
                    {ruleCategories.map((category, catIndex) => (
                        ...
                        >
                            ...
                            <div className="flex items-center gap-3 mb-4 border-b border-white/10 pb-3">
                                ...
                                <div>
                                    <h3 className="text-lg font-black text-slate-900 uppercase italic tracking-wide">{category.title}</h3>
                ...
                >
                    ...
                    <div className="grid md:grid-cols-2 gap-8 text-sm text-gray-300">
                        <div className="bg-blue-900/20 p-4 border border-blue-500/20">
                            <strong className="text-slate-900 block uppercase tracking-widest mb-2 border-b border-blue-500/30 pb-2">Typhoon Signal 8 / 八號風球</strong>
                        ...
                        <div className="bg-blue-900/20 p-4 border border-blue-500/20">
                            <strong className="text-slate-900 block uppercase tracking-widest mb-2 border-b border-blue-500/30 pb-2">Signal 3 / Thunderstorm 三號風球 / 雷暴</strong>
