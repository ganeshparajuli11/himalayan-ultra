            ...
            <header className="bg-white/5 border-b border-white/10 py-6">
                <div className="container mx-auto px-4 flex flex-col md:flex-row justify-between items-center gap-4">
                    <div className="text-center md:text-left">
                        <h1 className="text-3xl font-black text-slate-900 uppercase tracking-wider">Hello, <span className="text-primary">{user?.name || 'Runner'}</span></h1>
                        <p className="text-gray-400 text-sm mt-1">Welcome to your race dashboard.</p>
                    </div>
                    <button onClick={logout} className="btn btn-outline text-xs px-6 py-2 border-red-500 text-red-500 hover:bg-red-500 hover:text-slate-900">Logout</button>
                </div>
            </header>
            ...
            <div className="container mx-auto px-4 py-12 flex-grow">
                ...
                <div className="glass p-8 rounded-xl border-l-4 border-primary mb-12 shadow-2xl relative overflow-hidden">
                    <div className="absolute top-0 right-0 p-4 opacity-10">
                        <span className="text-9xl font-black text-slate-900">#1</span>
                    </div>
                    <h2 className="text-2xl font-bold text-slate-900 uppercase mb-6 relative z-10">Registration Status</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="bg-white/5 p-8 rounded-xl border border-white/10 hover:border-white/30 transition-all duration-300 group">
                        ...
                        <h3 className="text-xl font-bold text-slate-900 uppercase mb-2">My Results</h3>
                    ...
                    <div className="bg-white/5 p-8 rounded-xl border border-white/10 hover:border-white/30 transition-all duration-300 group">
                        ...
                        <h3 className="text-xl font-bold text-slate-900 uppercase mb-2">Training Plan</h3>
                        <p className="text-gray-400 text-sm mb-6">Access your personalized training schedule.</p>
                        <button className="text-primary text-sm font-bold uppercase tracking-wider hover:text-slate-900 transition-colors flex items-center gap-2">
